...
const RecipeDetailScreen = () => {
  ...
  useEffect(() => {
    ...
    const loadRecipeDetail = async () => {
      setLoading(true);
      try {
        const mealData = await MealAPI.getMealDetailsById(recipeId);
        if(mealData) {
  ...
  if (!recipe) {
    return <LoadingSpinner message="Recipe not found..." />;
  }
          ...
          {recipe.youtubeUrl && getYoutubeEmbedUrl(recipe.youtubeUrl) && (
            <View style={recipeDetailStyles.sectionContainer}>
              <View style={recipeDetailStyles.sectionTitleRow}>
                ...
                <Text style={recipeDetailStyles.sectionTitle}>Watch Video</Text>
              </View>
                  ...
                  source={{
                    html: `
                      ...
                      <html>
                        ...
                        <body>
                          <iframe 
                            src="${getYoutubeEmbedUrl(recipe.youtubeUrl)}?rel=0&modestbranding=1&playsinline=1" 
